...
$result = mysqli_query ($conn, "SELECT u.id,u.school_id,u.branch_id,u.title,u.name,u.type_id,u.contact,u.email,u.password,u.created,u.is_active,
    (SELECT name FROM school WHERE id = u.school_id) AS school_name,
    (SELECT name FROM branch WHERE id = u.branch_id) AS branch_name FROM users u");
?>
